...
Installs [Claude Code](https://claude.ai/code) and deploys a set of custom slash-command skills to the user's global Claude commands directory (`~/.claude/commands/`).
